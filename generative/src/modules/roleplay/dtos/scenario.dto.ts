...
export class CreateScenarioDto {
  ...
  @ApiProperty({
    example: 'You are applying for a software engineer role',
  ...
  @ApiProperty({
    example: 'A strict hiring manager',
    description: 'Persona of the AI',
  })
  @IsString()
  @IsNotEmpty()
  aiPersona!: string;
  ...
  @ApiPropertyOptional({
    example: true,
    description: 'Whether the scenario is available to all users',
  })
  @IsBoolean()
  @IsOptional()
  isPublic?: boolean;
...
export class GenerateScenarioDto {
  @ApiProperty({
    ...
    description: 'Desired topic or context',
  })
  @IsString()
  @IsNotEmpty()
  topic!: string;
  ...
  @ApiProperty({
    example: 'A2',
    description: 'Target CEFR level for the generated scenario',
  })
  @IsString()
  @IsNotEmpty()
  level!: string;
  ...
  @ApiPropertyOptional({
    example: true,
    description: 'Whether to make the generated scenario public',
  })
  @IsBoolean()
  @IsOptional()
  isPublic?: boolean;
