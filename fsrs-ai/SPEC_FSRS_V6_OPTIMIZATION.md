...
- Extend review item payload:
  ...
  - `hadWrong`: boolean, default false
...
- `review_log.logData.event` extend with:
  - `attempts`, `hadWrong`, `exerciseTypeNormalized`, `durationMsValid`.
...
- 2026-04-04: implemented core backend changes:
  - strict review payload validation (`durationMs`, enum normalization, attempts/hadWrong metadata)
